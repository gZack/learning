...
public class PartB {
	...
	final Function<CheckoutRecord,List<CheckoutRecordEntry>> checkoutRecordListFunction =
	...
	final Function<CheckoutRecord,List<CheckoutRecordEntry>> checkoutRecordListFunctionMR =
			CheckoutRecord::getCheckoutEntries;
	
	// provide an inner class that behaves the same way as the lambda
	//class My--- implements --- { }

	static class MyFunction implements Function<CheckoutRecord,List<CheckoutRecordEntry>>{
	...
	public void evaluator() {
		...
		System.out.println(checkoutRecordListFunction.apply(record));
		System.out.println(checkoutRecordListFunctionMR.apply(record));
