...
public class PartB {
	...
	final Function<CheckoutRecord,List<CheckoutRecordEntry>> listFunction
			= record -> record.getCheckoutEntries();
	
	//provide a method reference and the type of method reference
	//TYPE: 

	final Function<CheckoutRecord,List<CheckoutRecordEntry>> listFunction1
