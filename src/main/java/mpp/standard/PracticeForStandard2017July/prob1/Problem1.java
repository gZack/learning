package mpp.standard.PracticeForStandard2017July.prob1;
...
public class Problem1 {
	...
	public static List<String> elementsInJustOne(List<String> list1, List<String> list2) {
		//implement
		return Stream.concat(list1.stream().filter(s -> !list2.contains(s)), list2.stream()
	...
	public static List<String> getAllFairfieldCustomers(List<Customer> list) {
		//implement
		return list.stream()
				.filter(customer -> customer.getCity().equalsIgnoreCase("fairfield"))
